                      ...
                      <table  class="display table table-bordered table-striped" id="komoditis">
                        <thead>
                          <tr>
                              ...
                              <th style="text-align:center;" width="40%">Jenis Komoditi</th>
                              <th style="text-align:center;" width="40%">Nama Komoditi</th>
                              <th style="text-align:center;" width="10%">Aksi</th>
                          </tr>
                          </thead>
                          <tbody>
                          <?php $no = 1;?>
                          @foreach($komoditis as $value)
                            <tr>
                                ...
                                <td style="text-align:center;">
                                  <div class="btn-group">
                                    <a href="{{ route('admin.komoditis.edit', ['komoditis'=>Crypt::encrypt($value->id)]) }}" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
                                    {{ Form::open(array('url'=>route('admin.komoditis.destroy',['komoditis'=>$value->id]),'method'=>'delete', 'style'=>'display:inline;')) }}
