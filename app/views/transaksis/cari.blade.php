            ...
            <section class="panel">
                ...
                <div class="panel-body"  style:"overflow: scroll;">
                  <div class="form-inline">
                    ...
                    <div class="form-group">
                    {{ Form::label('tipe', 'Tipe Filter Berdasarkan') }}
                    {{ Form::select('tipe', array(''=>'', 'a'=>'Pencarian Berdasarkan Isian', 'b'=>'Triwulan', 'c'=>'Semua'), $tipe, array(
                            'id'=>'tipe',
                            'placeholder' => "Pilih Filter Bedasarkan",
                            'class'=>'form-control input-sm')) }}
                    </div>
                    ...
                    {{ Form::select('aktifitas', array(''=>'', 'BONGKAR'=>'BONGKAR', 'MUAT'=>'MUAT'), $aktifitas, array(
                            'id'=>'aktifitas',
                    ...
                    <div class="form-group">
                        ...
                        {{ Form::selectyear('tahun', 2015, 2020, $tahun, array(
                        'id'=>'tahun',
                        'placeholder' => "Tahun",
                        'class' => 'form-control input-sm')) }}
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      {{ Form::select('triwulan', array(''=>'', 'Triwulan I'=>'Triwulan I', 'Triwulan II'=>'Triwulan II', 'Triwulan III'=>'Triwulan III', 'Triwulan IV'=>'Triwulan IV'), $triwulan, array(
                              'id'=>'triwulan',
                    ...
                    <table  class="display table table-bordered table-striped" id="transaksi">
                      <thead>
                        <tr>
                            ...
                            <th style="display:none;">EMKL Asal</th>
                            <th style="display:none;">EMKL Tujuan</th>
...
@section('script')
  ...
  <script src="{{ asset('packages/select2/select2_locale_id.js')}}"></script>
 	<script type="text/javascript" charset="utf-8">
      ...
      $(document).ready(function() { $('#ejnskomoditis').dataTable(); });
      $(document).ready(function() { $("#eaktifitas").select2(); });
      $(document).ready(function() { $("#ebulan").select2(); });
      $(document).ready(function() { $("#etahun").select2(); });
      $(document).ready(function() { $("#easal").select2({ dropdownAutoWidth : true }); });
      $(document).ready(function() { $("#etujuan").select2({ dropdownAutoWidth : true }); });
      $(document).ready(function() { $("#etriwulan").select2({ dropdownAutoWidth : true }); });
      $(document).ready(function() { $("#etipe").select2({ dropdownAutoWidth : true }); });
	</script>
	<script type="text/javascript">
      ...
      function fnFormatDetails ( oTable, nTr )
      {
          ...
          sOut += '<tr><td>EMKL Asal:</td><td>'+aData[8]+'</td></tr>';
          sOut += '<tr><td>EMKL Tujuan:</td><td>'+aData[9]+'</td></tr>';
